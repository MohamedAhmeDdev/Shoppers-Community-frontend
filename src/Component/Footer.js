...
function Footer() {
  return (
    <footer class="w-full">
    <div class=" px-4 sm:px-6 lg:px-8 bg-blue-400">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 gap-y-8 md:gap-8 py-10 max-w-sm mx-auto sm:max-w-3xl lg:max-w-full">
            <div class="col-span-full mb-10 lg:col-span-2 lg:mb-0">
              ...
              <img src={logo} alt="Company Logo" className="object-cover object-center w-40 h-20" />
                ...
                <p class="py-8 text-sm text-white lg:max-w-xs text-center lg:text-left">we aim to solve the problem of evaluating the marginal benefit (MB) and cost-benefit (CB) of purchasing products from various e-shops</p>
            </div>
          
            <div class="lg:mx-auto text-left ">
                <h4 class="text-lg text-gray-900 font-medium mb-7">Pages</h4>
                <ul class="text-sm  transition-all duration-500">
                    <li class="mb-6"><a href="/"  class="text-white hover:text-gray-900">Home</a></li>
                    <li class="mb-6"><a href="/category"  class=" text-white hover:text-gray-900">Category</a></li>
                    <li class="mb-6"><a href="/about"  class=" text-white hover:text-gray-900">About</a></li>
                    <li class="mb-6"><a href="/about"  class=" text-white hover:text-gray-900">Contact</a></li>
                    <li class="mb-6"><a href="/about"  class=" text-white hover:text-gray-900">Login</a></li>
                </ul>
            </div>
        ...
        <div class="py-7 border-t border-gray-200">
            <div class="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                <span class="text-sm text-white ">©<a href="https://pagedone.io/">ShopHorizon</a> 2024, All rights reserved.</span>
                <div class="flex mt-4 space-x-4 sm:justify-center lg:mt-0 ">
                    <a href="https://x.com/"  class="w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[#33CCFF] hover:bg-[#f7444e]">
                    ...
                    <a href="https://www.instagram.com/?hl=en"  class="relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[linear-gradient(45deg,#FEE411_6.9%,#FEDB16_10.98%,#FEC125_17.77%,#FE983D_26.42%,#FE5F5E_36.5%,#FE2181_46.24%,#9000DC_85.57%)]  hover:bg-gradient-to-b from-[#f7444e] to-[#f7444e] 
                    ">
                    ...
                    <a href="https://www.facebook.com/"  class="relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[#337FFF]  hover:bg-[#f7444e] ">
